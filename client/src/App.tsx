...
function App() {
  ...
  return (
    ...
    {/* <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <ShipmentTracker currentStage={stage} />
    </div> */}
    </>
    
    // <div className="flex items-center justify-center min-h-screen bg-pink-500">
//       <section className="bg-white flex items-center justify-center min-h-screen py-8 antialiased dark:bg-gray-900 md:py-16">
...
//           <div className="flex items-center gap-6">
//             <a href="#" className="h-14 w-14 shrink-0">
//               <img className="h-full w-full dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-light.svg" alt="xbox image" />
...
//             <a href="#" className="min-w-0 flex-1 font-medium text-gray-900 hover:underline dark:text-white"> Xbox Series X Diablo IV Bundle + 2 Xbox Wireless Controller Carbon Black + Controller Charger </a>
//           </div>
...
//               <p className="text-xl font-bold leading-tight text-gray-900 dark:text-white">$699</p>
//             </div>
//           </div>
//         </div>
...
//           <div className="flex items-center gap-6">
//             <a href="#" className="h-14 w-14 shrink-0">
//               <img className="h-full w-full dark:hidden" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg" alt="phone image" />
...
//             <a href="#" className="min-w-0 flex-1 font-medium text-gray-900 hover:underline dark:text-white"> APPLE iPhone 15 5G phone, 256GB, Gold </a>
//           </div>
...
//             <div className="flex items-center justify-end gap-4">
//               <p className="text-base font-normal text-gray-900 dark:text-white">x3</p>

//               <p className="text-xl font-bold leading-tight text-gray-900 dark:text-white">$2,997</p>
//             </div>
//           </div>
//         </div>
